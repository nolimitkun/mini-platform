...
bash entry_point.sh us-east-2 ./production_stack_specification.yaml
bash set_up_efs.sh production-stack us-east-2 
```
...
bash clean_up.sh production-stack us-east-2 
```
